...
function gateway_vmerchant($seperator, $sessionid) {
  ...
  <input type="hidden" name="ssl_merchant_id" value="542736" /> 
  <input type="hidden" name="ssl_pin" value="JR1O36" /> 
  ...
  <input type="hidden" name="ssl_avs_address" value="139b Tasman St" />
  <input type="hidden" name="ssl_avs_zip" value="6023" />
